...
For example, if the cursor is on a comma in a list of function arguments, you can kbd:[alt+enter] > "`swap arguments`", and the order of arguments will be changed in the declaration and on various call-sites as well.
