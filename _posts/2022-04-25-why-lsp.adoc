...
Still, I do want to claim that we had no editors capable of being and IDE.
...
The quality of IDE support is improving rapidly for all the languages, though I feel this is only a begining of a long road.
One thing to keep in mind is that LSP is _an_ inteface to a semantic info about the language, but it isn't _the_ inteface.
